<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="JILIGULU.Update" %>
...
<body>
    ...
    <form class="Box" runat="server">
        ...
        <textarea runat="server" id="Title" class="Title" placeholder="Title"></textarea>
        <textarea runat="server" id="Mode" class="Mode" placeholder="Mode"></textarea>
        <textarea runat="server" id="Type" class="Type" placeholder="Type"></textarea>

        <textarea runat="server" id="Summary" class="Summary" placeholder="Summary"></textarea>
        <textarea runat="server" id="Archiv" class="Archiv" placeholder="Archiv"></textarea>
        <textarea runat="server" id="Label" class="Label" placeholder="Label"></textarea>
        <textarea runat="server" id="Content" class="Content" placeholder="Content"></textarea>

        <textarea runat="server" id="StarCount" class="StarCount" placeholder="StarCount"></textarea>
        <textarea runat="server" id="UVCount" class="UVCount" placeholder="UVCount"></textarea>
        <textarea runat="server" id="Cover" class="Cover" placeholder="Cover"></textarea>
