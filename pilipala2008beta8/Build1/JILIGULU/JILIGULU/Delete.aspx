<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Delete.aspx.cs" Inherits="JILIGULU.Delete" %>
...
<body>
    ...
    <form class="Box" runat="server">
        ...
        <textarea runat="server" id="GUID" class="ID" placeholder="GUID"></textarea>
    </form>
</body>
