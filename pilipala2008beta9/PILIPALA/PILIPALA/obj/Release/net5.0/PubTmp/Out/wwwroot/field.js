...
function putWordCount() {
    let count = wordCount($("#CardCol>.Col>.Card>.contain>.Content").text());
    let time = Math.ceil(count / 400);
    /*空格为全角*/
...
/* 刷新StarCount计数 */
const refre_StarCount = throttle(function (ID) {
...
/* 刷新UVCount计数 */
const refre_UVCount = throttle(function (ID) {
