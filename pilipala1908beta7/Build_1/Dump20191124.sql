...
INSERT INTO `pala_text_index` VALUES (12347,'show','p'),(12350,'show','p'),(12351,'show','p'),(12356,'show','p'),(12359,'show','p'),(12364,'show','p'),(12365,'show','p'),(12366,'show','p'),(12369,'show','p'),(12373,'show','p'),(12376,'show','p'),(12377,'show','p'),(12379,'show','p'),(12380,'show','p'),(12381,'show','p'),(12382,'show','p'),(12383,'show','p'),(12384,'show','p'),(12385,'show','p'),(12386,'show','p'),(12387,'show','p'),(12388,'show','p'),(12389,'show','p'),(12390,'show','p'),(12393,'show','p'),(12394,'show','p'),(12395,'show','p'),(12396,'show','p'),(12397,'show','p'),(12398,'show','p'),(12399,'show','p'),(12400,'show','p'),(12401,'show','p'),(12402,'show','p'),(12403,'show','p'),(12404,'show','n');
...
CREATE TABLE `pala_text_main` (
  ...
  `text_content` longtext CHARACTER SET utf8,
  PRIMARY KEY (`text_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12405 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pala_text_sub` (
  `text_id` int(5) unsigned NOT NULL AUTO_INCREMENT,
  `text_archiv` varchar(16) DEFAULT NULL,
  `text_editor` char(32) DEFAULT 'pinn',
  `date_created` datetime DEFAULT NULL,
  `date_changed` datetime DEFAULT NULL,
  `count_pv` int(5) unsigned DEFAULT '3',
  `count_comment` int(5) unsigned DEFAULT '0',
  `count_star` int(5) unsigned DEFAULT '1',
  `tags` varchar(128) DEFAULT NULL,
  `before_html` varchar(2048) DEFAULT NULL,
  PRIMARY KEY (`text_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12405 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pala_text_sub` VALUES (12347,'技术','Thaumy','2017-01-15 06:18:32','2017-08-05 13:33:45',334,0,53,'远古文章',NULL),(12350,'技术','Thaumy','2017-04-21 23:05:03','2017-07-23 14:23:10',245,0,29,'远古文章',''),(12351,'技术','Thaumy','2017-05-20 04:24:44','2017-10-28 15:49:54',315,0,56,'远古文章',NULL),(12356,'技术','Thaumy','2017-06-17 04:16:29','2017-07-12 10:13:21',331,0,42,'远古文章',NULL),(12359,'技术','Thaumy','2017-06-18 00:00:01','2017-07-12 10:13:16',203,0,41,'远古文章',NULL),(12364,'技术','Thaumy','2017-07-11 03:10:51','2017-07-12 10:13:06',236,0,47,'远古文章',NULL),(12365,'技术','Thaumy','2017-07-21 02:24:07','2017-08-15 03:46:00',261,0,52,'远古文章',NULL),(12366,'技术','Thaumy','2017-07-26 09:16:30','2018-04-14 22:53:20',281,0,34,'远古文章',NULL),(12369,'技术','Thaumy','2017-12-02 07:06:14','2018-04-14 22:52:19',241,0,44,'远古文章',NULL),(12373,'技术','Thaumy','2018-04-05 22:46:31','2018-04-14 22:55:40',223,0,38,'远古文章',''),(12376,'页面','Thaumy','2019-03-09 19:23:39','2019-10-20 07:19:49',340,0,84,'工程日志$维护',NULL),(12377,'技术','Thaumy','2019-03-09 22:49:33','2019-04-14 06:08:43',212,0,44,'噼里啪啦工程组$PB6','<img class=\"pXL\" src=\"http://thblog-img.test.upcdn.net/md-img/pilipalabeta6.png\">'),(12379,'页面','Thaumy','2019-04-05 17:46:42','2019-11-24 17:46:44',153,0,58,'签名$语录',NULL),(12380,'生活','水瓜社','2019-04-13 23:51:00','2019-04-21 09:52:58',190,0,43,'水瓜社$工作室','<img class=\"pXL\" src=\"http://thblog-img.test.upcdn.net/md-img/h2omelonsocie.jpg\">'),(12381,'生活','Thaumy','2019-04-13 23:51:04','2019-11-24 07:54:22',167,0,41,'Thaumy$二次元',NULL),(12382,'页面','Thaumy','2019-04-14 06:58:04','2019-06-06 17:16:55',135,0,54,'噼里啪啦工程组','<img class=\"pXL\" src=\"http://thblog-img.test.upcdn.net/md-img/aboutPilipala.png\">'),(12383,'站点构建','Thaumy','2019-05-11 18:02:54','2019-08-21 08:47:26',232,0,53,'引导',NULL),(12384,'置顶','Thaumy','2019-05-11 18:18:36','2019-05-11 18:18:39',298,0,32,'引导',NULL),(12385,'页面','水瓜社','2019-05-25 21:55:39','2019-05-25 21:55:42',200,0,46,'水瓜储蓄事务局',NULL),(12386,'技术','Thaumy','2019-05-26 00:39:38','2019-06-29 19:33:09',92,0,22,'噼里啪啦工程组$PB7','<img class=\"pXL\" src=\"http://thblog-img.test.upcdn.net/md-img/pilipalabeta7preview.jpg\">'),(12387,'页面','Thaumy','2019-06-16 07:12:31','2019-10-20 07:20:22',55,0,23,'杂记',NULL),(12388,'站点构建','Pinn','2019-06-29 23:15:38','2019-10-20 07:20:03',48,0,12,'',NULL),(12389,'技术','Thaumy','2019-06-30 06:31:16','2019-06-30 06:31:18',32,0,14,'噼里啪啦工程组',NULL),(12390,'生活','Thaumy','2019-07-11 13:53:36','2019-07-11 13:53:34',32,0,6,'可怜的Thaumy',NULL),(12393,'技术','Thaumy','2019-08-08 22:12:04','2019-08-08 22:12:04',18,0,10,'',NULL),(12394,'技术','Thaumy','2019-08-25 09:59:35','2019-08-31 22:30:54',37,0,12,'客制化','<img class=\"pXL\" src=\"http://thblog-img.test.upcdn.net/md-img/field2cg.jpg\">'),(12395,'技术','Thaumy','2019-08-27 08:17:30','2019-08-31 22:30:54',13,0,2,'例程$C#',NULL),(12396,'技术','Thaumy','2019-09-06 19:10:39','2019-08-31 22:30:54',12,0,9,'噼里啪啦工程组$PB7',NULL),(12397,'生活','雅爱方雏','2019-10-01 18:40:16','2019-10-01 18:40:16',9,0,4,'雅爱方雏设计局$联动$国庆节','<img class=\"pXL\" src=\"http://thblog-img.test.upcdn.net/md-img/cn70th.jpg\">'),(12398,'维护日志','Thaumy','2019-11-02 19:09:19','2019-11-02 19:09:35',9,0,1,'',NULL),(12399,'维护日志','Thaumy','2019-11-02 19:09:23','2019-11-02 19:09:39',11,0,0,'',NULL),(12400,'维护日志','Thaumy','2019-11-02 19:09:26','2019-11-24 19:09:41',13,0,1,'',NULL),(12401,'维护日志','Thaumy','2019-11-02 19:09:29','2019-11-02 19:09:44',6,0,0,'',NULL),(12402,'维护日志','Thaumy','2019-11-02 19:09:32','2019-11-24 19:09:46',9,0,0,'',NULL),(12403,'生活','Thaumy','2019-11-16 22:39:05','2019-11-16 22:39:08',6,0,5,'Linux工作流',NULL),(12404,'生活','Thaumy','2019-11-17 08:25:06','2019-11-17 08:25:08',7,0,3,' ',NULL);
...
WHERE
	...
	AND ( `pala_text_index`.`text_mode` = 'show' ) /* 排除不参与随机取样的文章 */
...
/*!50001 VIEW `view>index` AS select `pala_text_index`.`text_id` AS `text_id`,`pala_text_index`.`text_type` AS `text_type` from `pala_text_index` where (`pala_text_index`.`text_mode` = 'show') order by `pala_text_index`.`text_id` desc */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`thaumy0tdymy`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view>index.page` AS select `pala_text_index`.`text_id` AS `text_id`,`pala_text_index`.`text_type` AS `text_type` from `pala_text_index` where ((`pala_text_index`.`text_type` = 'page') and (`pala_text_index`.`text_mode` = 'show')) order by `pala_text_index`.`text_id` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`thaumy0tdymy`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `view>index.post` AS select `pala_text_index`.`text_id` AS `text_id`,`pala_text_index`.`text_type` AS `text_type` from `pala_text_index` where ((`pala_text_index`.`text_type` = 'post') and (`pala_text_index`.`text_mode` = 'show')) order by `pala_text_index`.`text_id` desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2019-11-24  7:52:04
