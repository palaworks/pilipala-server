...
public class webioBridge : Page
{
    ...
    public webioBridge()
    {
        ...
        palaF = new palaFunction(MyCH, "thaumymysql");//启动站点函数
        palaRoot = new palaRoot(MyCH, "thaumymysql");//启动根级控制器
        getPost = new GetPost(MyCH, "thaumymysql");//启动Post获得器
        setPost = new SetPost(MyCH, "thaumymysql");//启动Post编辑器
    }
