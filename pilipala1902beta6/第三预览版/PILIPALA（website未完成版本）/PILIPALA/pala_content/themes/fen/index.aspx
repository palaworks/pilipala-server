        ...
        <div class="GuideCol">
            <div class="GuideBox">
                ...
                <div class="GuideCardBox fltL RdiuB MagnB">
                    ...
                    %>
                    <a href="index.aspx?text_id=<%Response.Write(PaTextMain.text_id); %>" onclick="showDeepin(<%Response.Write(PaTextMain.text_id); %>)" target="_self" class="GuideCard RdiuB RdiuT flx Tran">
